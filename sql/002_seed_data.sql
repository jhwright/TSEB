...
insert into gigs (id, institution_id, gig_date, gig_time, recurrence, notes) values
  ...
  ('c0000001-0000-0000-0000-000000000001', 'b0000001-0000-0000-0000-000000000001', '2025-09-04', null, 'weekly',
    'Weekly sing. Penelope every other week.'),
  -- Kaiser NICU - weekly
  ('c0000001-0000-0000-0000-000000000002', 'b0000001-0000-0000-0000-000000000002', '2025-09-04', null, 'weekly',
    'Weekly NICU sing'),
  -- Mercy Retirement - weekly
  ('c0000001-0000-0000-0000-000000000003', 'b0000001-0000-0000-0000-000000000003', '2025-09-04', null, 'weekly',
    'Weekly sing. Adding Memory Care starting 2025.09.04.'),
  -- Piedmont Gardens SNF - Team A monthly
  ('c0000001-0000-0000-0000-000000000004', 'b0000001-0000-0000-0000-000000000004', '2025-09-01', null, 'monthly',
    'Team A - monthly'),
  -- Piedmont Gardens SNF - Team B monthly
  ('c0000001-0000-0000-0000-000000000005', 'b0000001-0000-0000-0000-000000000004', '2025-09-15', null, 'monthly',
    'Team B - monthly'),
  -- Lakeside - 2x/month
  ('c0000001-0000-0000-0000-000000000006', 'b0000001-0000-0000-0000-000000000005', '2025-09-01', null, '2x_month',
    '2x/month sing');
